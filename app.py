...
# Sidebar for new game analysis (always visible)
with st.sidebar:    
    # Affichage des éléments d'analyse dans la sidebar si en mode analyse
...
# Check if we should show dashboard or analysis
if st.session_state.analysis_result and st.session_state.analysis_result.analysis:
        ...
        if st.session_state.analysis_result and st.session_state.analysis_result.analysis:
            with st.container(horizontal=True, vertical_alignment="bottom"):
                if st.button("Dashboard",
                    ...
                    # Clear analysis to return to dashboard
